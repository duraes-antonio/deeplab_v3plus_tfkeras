...
from deeplab_v3plus_tfkeras.metrics import make_IoU, make_categorical_IoU, make_F1score, make_categorical_F1score, f1_score
...
if output_activation == "softmax":
	if loss == "CE":
		...
		loss_function = \
			my_loss_func.make_focal_loss(label.n_labels, fl_alpha_list, fl_gamma_list)
	elif loss == "GDL":
...
if n_gpus >= 2:
	...
	model.compile(
		...
		metrics=metrics_list, run_eagerly=True,
	)
model.summary()
